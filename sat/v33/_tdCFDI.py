...
# Generated 2017-05-11 13:42:28.249461 by PyXB version 1.2.5 using Python 3.5.3.final.0
...
t_CURP._InitializeFacetMap(t_CURP._CF_length,
...
t_Importe._InitializeFacetMap(t_Importe._CF_whiteSpace,
   t_Importe._CF_minInclusive,
   t_Importe._CF_fractionDigits,
   t_Importe._CF_pattern)
...
t_Fecha._InitializeFacetMap(t_Fecha._CF_whiteSpace,
   t_Fecha._CF_pattern)
...
t_ImporteMXN._InitializeFacetMap(t_ImporteMXN._CF_whiteSpace,
   t_ImporteMXN._CF_minInclusive,
   t_ImporteMXN._CF_fractionDigits,
   t_ImporteMXN._CF_pattern)
...
t_CuentaBancaria._InitializeFacetMap(t_CuentaBancaria._CF_whiteSpace,
   t_CuentaBancaria._CF_pattern)
...
t_RFC._InitializeFacetMap(t_RFC._CF_whiteSpace,
   t_RFC._CF_minLength,
   t_RFC._CF_maxLength,
   t_RFC._CF_pattern)
...
t_RFC_PM._InitializeFacetMap(t_RFC_PM._CF_whiteSpace,
   t_RFC_PM._CF_minLength,
   t_RFC_PM._CF_pattern)
...
t_RFC_PF._InitializeFacetMap(t_RFC_PF._CF_whiteSpace,
   t_RFC_PF._CF_minLength,
   t_RFC_PF._CF_pattern)
...
t_FechaHora._InitializeFacetMap(t_FechaHora._CF_whiteSpace,
   t_FechaHora._CF_pattern)
...
t_FechaH._InitializeFacetMap(t_FechaH._CF_whiteSpace,
   t_FechaH._CF_pattern)
...
t_Descrip100._InitializeFacetMap(t_Descrip100._CF_whiteSpace,
   t_Descrip100._CF_minLength,
   t_Descrip100._CF_maxLength,
   t_Descrip100._CF_pattern)
...
t_NumeroDomicilio._InitializeFacetMap(t_NumeroDomicilio._CF_whiteSpace,
   t_NumeroDomicilio._CF_minLength,
   t_NumeroDomicilio._CF_maxLength,
   t_NumeroDomicilio._CF_pattern)
...
t_Referencia._InitializeFacetMap(t_Referencia._CF_whiteSpace,
   t_Referencia._CF_minLength,
   t_Referencia._CF_maxLength,
   t_Referencia._CF_pattern)
...
t_Descrip120._InitializeFacetMap(t_Descrip120._CF_whiteSpace,
   t_Descrip120._CF_minLength,
   t_Descrip120._CF_maxLength,
   t_Descrip120._CF_pattern)
...
t_TipoCambio._InitializeFacetMap(t_TipoCambio._CF_whiteSpace,
   t_TipoCambio._CF_minInclusive,
   t_TipoCambio._CF_fractionDigits,
   t_TipoCambio._CF_pattern)
