...
# Generated 2017-05-11 13:42:28.250132 by PyXB version 1.2.5 using Python 3.5.3.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:68e0eaba-3679-11e7-bb58-70188b13bae9')
...
import _tdCFDI as _ImportedBinding__tdCFDI
import pyxb.binding.datatypes
import _catCFDI as _ImportedBinding__catCFDI
...
class STD_ANON (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 26, 20)
    _Documentation = None
...
class STD_ANON_ (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 58, 14)
    _Documentation = None
...
STD_ANON_._CF_pattern.addPattern(pattern='([A-Z]|[a-z]|[0-9]| |Ñ|ñ|!|"|%|&|\'|´|-|:|;|>|=|<|@|_|,|\\{|\\}|`|~|á|é|í|ó|ú|Á|É|Í|Ó|Ú|ü|Ü){1,254}')
...
class STD_ANON_2 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 88, 14)
    _Documentation = None
...
STD_ANON_2._CF_pattern.addPattern(pattern='([A-Z]|[a-z]|[0-9]| |Ñ|ñ|!|"|%|&|\'|´|-|:|;|>|=|<|@|_|,|\\{|\\}|`|~|á|é|í|ó|ú|Á|É|Í|Ó|Ú|ü|Ü){1,254}')
...
class STD_ANON_3 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 106, 14)
    _Documentation = None
...
STD_ANON_3._InitializeFacetMap(STD_ANON_3._CF_whiteSpace,
...
class STD_ANON_4 (pyxb.binding.datatypes.decimal):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 210, 38)
    _Documentation = None
STD_ANON_4._CF_minInclusive = pyxb.binding.facets.CF_minInclusive(value_datatype=STD_ANON_4, value=pyxb.binding.datatypes.decimal('0.0'))
...
class STD_ANON_5 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 240, 26)
    _Documentation = None
STD_ANON_5._CF_length = pyxb.binding.facets.CF_length(value=pyxb.binding.datatypes.nonNegativeInteger(21))
STD_ANON_5._CF_pattern = pyxb.binding.facets.CF_pattern()
STD_ANON_5._CF_pattern.addPattern(pattern='[0-9]{2}  [0-9]{2}  [0-9]{4}  [0-9]{7}')
STD_ANON_5._InitializeFacetMap(STD_ANON_5._CF_length,
   STD_ANON_5._CF_pattern)
...
class STD_ANON_6 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 258, 26)
    _Documentation = None
...
STD_ANON_6._CF_maxLength = pyxb.binding.facets.CF_maxLength(value=pyxb.binding.datatypes.nonNegativeInteger(150))
STD_ANON_6._CF_pattern = pyxb.binding.facets.CF_pattern()
STD_ANON_6._CF_pattern.addPattern(pattern='[0-9]{1,150}')
STD_ANON_6._InitializeFacetMap(STD_ANON_6._CF_whiteSpace,
...
class STD_ANON_7 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 294, 32)
    _Documentation = None
STD_ANON_7._CF_length = pyxb.binding.facets.CF_length(value=pyxb.binding.datatypes.nonNegativeInteger(21))
STD_ANON_7._CF_pattern = pyxb.binding.facets.CF_pattern()
STD_ANON_7._CF_pattern.addPattern(pattern='[0-9]{2}  [0-9]{2}  [0-9]{4}  [0-9]{7}')
STD_ANON_7._InitializeFacetMap(STD_ANON_7._CF_length,
   STD_ANON_7._CF_pattern)
...
class STD_ANON_8 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 313, 26)
    _Documentation = None
STD_ANON_8._CF_whiteSpace = pyxb.binding.facets.CF_whiteSpace(value=pyxb.binding.facets._WhiteSpace_enum.collapse)
...
STD_ANON_8._CF_pattern.addPattern(pattern='([A-Z]|[a-z]|[0-9]| |Ñ|ñ|!|"|%|&|\'|´|-|:|;|>|=|<|@|_|,|\\{|\\}|`|~|á|é|í|ó|ú|Á|É|Í|Ó|Ú|ü|Ü){1,100}')
STD_ANON_8._InitializeFacetMap(STD_ANON_8._CF_whiteSpace,
   STD_ANON_8._CF_minLength,
   STD_ANON_8._CF_maxLength,
   STD_ANON_8._CF_pattern)
...
class STD_ANON_9 (pyxb.binding.datatypes.decimal):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 326, 26)
    _Documentation = None
STD_ANON_9._CF_minInclusive = pyxb.binding.facets.CF_minInclusive(value_datatype=STD_ANON_9, value=pyxb.binding.datatypes.decimal('0.000001'))
STD_ANON_9._CF_fractionDigits = pyxb.binding.facets.CF_fractionDigits(value=pyxb.binding.datatypes.nonNegativeInteger(6))
...
class STD_ANON_10 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 338, 26)
    _Documentation = None
...
STD_ANON_10._CF_maxLength = pyxb.binding.facets.CF_maxLength(value=pyxb.binding.datatypes.nonNegativeInteger(20))
STD_ANON_10._CF_pattern = pyxb.binding.facets.CF_pattern()
STD_ANON_10._CF_pattern.addPattern(pattern='([A-Z]|[a-z]|[0-9]| |Ñ|ñ|!|"|%|&|\'|´|-|:|;|>|=|<|@|_|,|\\{|\\}|`|~|á|é|í|ó|ú|Á|É|Í|Ó|Ú|ü|Ü){1,20}')
STD_ANON_10._InitializeFacetMap(STD_ANON_10._CF_whiteSpace,
   STD_ANON_10._CF_minLength,
   STD_ANON_10._CF_maxLength,
   STD_ANON_10._CF_pattern)
...
class STD_ANON_11 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 351, 26)
    _Documentation = None
...
STD_ANON_11._CF_maxLength = pyxb.binding.facets.CF_maxLength(value=pyxb.binding.datatypes.nonNegativeInteger(1000))
STD_ANON_11._CF_pattern = pyxb.binding.facets.CF_pattern()
STD_ANON_11._CF_pattern.addPattern(pattern='([A-Z]|[a-z]|[0-9]| |Ñ|ñ|!|"|%|&|\'|´|-|:|;|>|=|<|@|_|,|\\{|\\}|`|~|á|é|í|ó|ú|Á|É|Í|Ó|Ú|ü|Ü){1,1000}')
STD_ANON_11._InitializeFacetMap(STD_ANON_11._CF_whiteSpace,
   STD_ANON_11._CF_minLength,
   STD_ANON_11._CF_maxLength,
   STD_ANON_11._CF_pattern)
...
class STD_ANON_12 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 382, 20)
    _Documentation = None
...
STD_ANON_12._CF_pattern.addPattern(pattern='([A-Z]|[a-z]|[0-9]| |Ñ|ñ|!|"|%|&|\'|´|-|:|;|>|=|<|@|_|,|\\{|\\}|`|~|á|é|í|ó|ú|Á|É|Í|Ó|Ú|ü|Ü){1,100}')
STD_ANON_12._InitializeFacetMap(STD_ANON_12._CF_whiteSpace,
   STD_ANON_12._CF_minLength,
   STD_ANON_12._CF_maxLength,
   STD_ANON_12._CF_pattern)
...
class STD_ANON_13 (pyxb.binding.datatypes.decimal):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 395, 20)
    _Documentation = None
STD_ANON_13._CF_minInclusive = pyxb.binding.facets.CF_minInclusive(value_datatype=STD_ANON_13, value=pyxb.binding.datatypes.decimal('0.000001'))
STD_ANON_13._CF_fractionDigits = pyxb.binding.facets.CF_fractionDigits(value=pyxb.binding.datatypes.nonNegativeInteger(6))
...
class STD_ANON_14 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 412, 20)
    _Documentation = None
...
STD_ANON_14._CF_pattern.addPattern(pattern='([A-Z]|[a-z]|[0-9]| |Ñ|ñ|!|"|%|&|\'|´|-|:|;|>|=|<|@|_|,|\\{|\\}|`|~|á|é|í|ó|ú|Á|É|Í|Ó|Ú|ü|Ü){1,20}')
STD_ANON_14._InitializeFacetMap(STD_ANON_14._CF_whiteSpace,
...
class STD_ANON_15 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 425, 20)
    _Documentation = None
...
STD_ANON_15._CF_maxLength = pyxb.binding.facets.CF_maxLength(value=pyxb.binding.datatypes.nonNegativeInteger(1000))
STD_ANON_15._CF_pattern = pyxb.binding.facets.CF_pattern()
STD_ANON_15._CF_pattern.addPattern(pattern='([A-Z]|[a-z]|[0-9]| |Ñ|ñ|!|"|%|&|\'|´|-|:|;|>|=|<|@|_|,|\\{|\\}|`|~|á|é|í|ó|ú|Á|É|Í|Ó|Ú|ü|Ü){1,1000}')
STD_ANON_15._InitializeFacetMap(STD_ANON_15._CF_whiteSpace,
...
class STD_ANON_16 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 560, 8)
    _Documentation = None
STD_ANON_16._CF_whiteSpace = pyxb.binding.facets.CF_whiteSpace(value=pyxb.binding.facets._WhiteSpace_enum.collapse)
STD_ANON_16._InitializeFacetMap(STD_ANON_16._CF_whiteSpace)
...
class STD_ANON_17 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 570, 8)
    _Documentation = None
...
STD_ANON_17._CF_pattern.addPattern(pattern='([A-Z]|[a-z]|[0-9]| |Ñ|ñ|!|"|%|&|\'|´|-|:|;|>|=|<|@|_|,|\\{|\\}|`|~|á|é|í|ó|ú|Á|É|Í|Ó|Ú|ü|Ü){1,25}')
STD_ANON_17._InitializeFacetMap(STD_ANON_17._CF_whiteSpace,
   STD_ANON_17._CF_minLength,
   STD_ANON_17._CF_maxLength,
   STD_ANON_17._CF_pattern)
...
class STD_ANON_18 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 583, 8)
    _Documentation = None
...
STD_ANON_18._CF_pattern.addPattern(pattern='([A-Z]|[a-z]|[0-9]| |Ñ|ñ|!|"|%|&|\'|´|-|:|;|>|=|<|@|_|,|\\{|\\}|`|~|á|é|í|ó|ú|Á|É|Í|Ó|Ú|ü|Ü){1,40}')
STD_ANON_18._InitializeFacetMap(STD_ANON_18._CF_whiteSpace,
   STD_ANON_18._CF_minLength,
   STD_ANON_18._CF_maxLength,
   STD_ANON_18._CF_pattern)
...
class STD_ANON_19 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 601, 8)
    _Documentation = None
STD_ANON_19._CF_whiteSpace = pyxb.binding.facets.CF_whiteSpace(value=pyxb.binding.facets._WhiteSpace_enum.collapse)
STD_ANON_19._InitializeFacetMap(STD_ANON_19._CF_whiteSpace)
...
class STD_ANON_20 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 616, 8)
    _Documentation = None
STD_ANON_20._CF_length = pyxb.binding.facets.CF_length(value=pyxb.binding.datatypes.nonNegativeInteger(20))
...
STD_ANON_20._CF_pattern.addPattern(pattern='[0-9]{20}')
STD_ANON_20._InitializeFacetMap(STD_ANON_20._CF_length,
   STD_ANON_20._CF_whiteSpace,
   STD_ANON_20._CF_pattern)
...
class STD_ANON_21 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 628, 8)
    _Documentation = None
STD_ANON_21._CF_whiteSpace = pyxb.binding.facets.CF_whiteSpace(value=pyxb.binding.facets._WhiteSpace_enum.collapse)
STD_ANON_21._InitializeFacetMap(STD_ANON_21._CF_whiteSpace)
...
class STD_ANON_22 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 638, 8)
    _Documentation = None
...
STD_ANON_22._CF_maxLength = pyxb.binding.facets.CF_maxLength(value=pyxb.binding.datatypes.nonNegativeInteger(1000))
STD_ANON_22._CF_pattern = pyxb.binding.facets.CF_pattern()
STD_ANON_22._CF_pattern.addPattern(pattern='([A-Z]|[a-z]|[0-9]| |Ñ|ñ|!|"|%|&|\'|´|-|:|;|>|=|<|@|_|,|\\{|\\}|`|~|á|é|í|ó|ú|Á|É|Í|Ó|Ú|ü|Ü){1,1000}')
STD_ANON_22._InitializeFacetMap(STD_ANON_22._CF_whiteSpace,
   STD_ANON_22._CF_minLength,
   STD_ANON_22._CF_maxLength,
   STD_ANON_22._CF_pattern)
...
class STD_ANON_23 (pyxb.binding.datatypes.decimal):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 666, 8)
    _Documentation = None
STD_ANON_23._CF_minInclusive = pyxb.binding.facets.CF_minInclusive(value_datatype=STD_ANON_23, value=pyxb.binding.datatypes.decimal('0.000001'))
STD_ANON_23._CF_fractionDigits = pyxb.binding.facets.CF_fractionDigits(value=pyxb.binding.datatypes.nonNegativeInteger(6))
...
class STD_ANON_24 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 698, 8)
    _Documentation = None
STD_ANON_24._CF_length = pyxb.binding.facets.CF_length(value=pyxb.binding.datatypes.nonNegativeInteger(5))
...
class CTD_ANON (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 125, 10)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.sat.gob.mx/cfd/3}Concepto uses Python identifier Concepto
    __Concepto = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Concepto'), 'Concepto', '__httpwww_sat_gob_mxcfd3_CTD_ANON_httpwww_sat_gob_mxcfd3Concepto', True, pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 127, 14), )
...
class CTD_ANON_ (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 137, 22)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.sat.gob.mx/cfd/3}Traslados uses Python identifier Traslados
    __Traslados = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Traslados'), 'Traslados', '__httpwww_sat_gob_mxcfd3_CTD_ANON__httpwww_sat_gob_mxcfd3Traslados', False, pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 139, 26), )
    ...
    __Retenciones = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Retenciones'), 'Retenciones', '__httpwww_sat_gob_mxcfd3_CTD_ANON__httpwww_sat_gob_mxcfd3Retenciones', False, pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 180, 26), )
...
class CTD_ANON_2 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 143, 28)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.sat.gob.mx/cfd/3}Traslado uses Python identifier Traslado
    __Traslado = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Traslado'), 'Traslado', '__httpwww_sat_gob_mxcfd3_CTD_ANON_2_httpwww_sat_gob_mxcfd3Traslado', True, pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 145, 32), )
...
class CTD_ANON_3 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 184, 28)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.sat.gob.mx/cfd/3}Retencion uses Python identifier Retencion
    __Retencion = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Retencion'), 'Retencion', '__httpwww_sat_gob_mxcfd3_CTD_ANON_3_httpwww_sat_gob_mxcfd3Retencion', True, pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 186, 32), )
...
class CTD_ANON_4 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 273, 22)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
...
class CTD_ANON_5 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 464, 16)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.sat.gob.mx/cfd/3}Retencion uses Python identifier Retencion
    __Retencion = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Retencion'), 'Retencion', '__httpwww_sat_gob_mxcfd3_CTD_ANON_5_httpwww_sat_gob_mxcfd3Retencion', True, pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 466, 20), )
...
class CTD_ANON_6 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 490, 16)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.sat.gob.mx/cfd/3}Traslado uses Python identifier Traslado
    __Traslado = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Traslado'), 'Traslado', '__httpwww_sat_gob_mxcfd3_CTD_ANON_6_httpwww_sat_gob_mxcfd3Traslado', True, pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 492, 20), )
...
class CTD_ANON_7 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 539, 10)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    _HasWildcardElement = True
...
class CTD_ANON_8 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 549, 10)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    _HasWildcardElement = True
...
class CTD_ANON_9 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 9, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.sat.gob.mx/cfd/3}CfdiRelacionados uses Python identifier CfdiRelacionados
    __CfdiRelacionados = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'CfdiRelacionados'), 'CfdiRelacionados', '__httpwww_sat_gob_mxcfd3_CTD_ANON_9_httpwww_sat_gob_mxcfd3CfdiRelacionados', False, pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 11, 8), )
    ...
    __Emisor = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Emisor'), 'Emisor', '__httpwww_sat_gob_mxcfd3_CTD_ANON_9_httpwww_sat_gob_mxcfd3Emisor', False, pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 44, 8), )
    ...
    __Receptor = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Receptor'), 'Receptor', '__httpwww_sat_gob_mxcfd3_CTD_ANON_9_httpwww_sat_gob_mxcfd3Receptor', False, pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 74, 8), )
    ...
    __Conceptos = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Conceptos'), 'Conceptos', '__httpwww_sat_gob_mxcfd3_CTD_ANON_9_httpwww_sat_gob_mxcfd3Conceptos', False, pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 121, 8), )
    ...
    __Impuestos = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Impuestos'), 'Impuestos', '__httpwww_sat_gob_mxcfd3_CTD_ANON_9_httpwww_sat_gob_mxcfd3Impuestos', False, pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 454, 8), )
    ...
    __Complemento = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Complemento'), 'Complemento', '__httpwww_sat_gob_mxcfd3_CTD_ANON_9_httpwww_sat_gob_mxcfd3Complemento', False, pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 535, 8), )
    ...
    __Addenda = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Addenda'), 'Addenda', '__httpwww_sat_gob_mxcfd3_CTD_ANON_9_httpwww_sat_gob_mxcfd3Addenda', False, pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 545, 8), )
    ...
    __Version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'Version'), 'Version', '__httpwww_sat_gob_mxcfd3_CTD_ANON_9_Version', _module_typeBindings.STD_ANON_16, fixed=True, unicode_default='3.3', required=True)
    __Version._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 556, 6)
    __Version._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 556, 6)
    ...
    __Serie = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'Serie'), 'Serie', '__httpwww_sat_gob_mxcfd3_CTD_ANON_9_Serie', _module_typeBindings.STD_ANON_17)
    __Serie._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 566, 6)
    __Serie._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 566, 6)
    ...
    __Folio = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'Folio'), 'Folio', '__httpwww_sat_gob_mxcfd3_CTD_ANON_9_Folio', _module_typeBindings.STD_ANON_18)
    __Folio._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 579, 6)
    __Folio._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 579, 6)
    ...
    __Fecha._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 592, 6)
    __Fecha._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 592, 6)
    ...
    __Sello = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'Sello'), 'Sello', '__httpwww_sat_gob_mxcfd3_CTD_ANON_9_Sello', _module_typeBindings.STD_ANON_19, required=True)
    __Sello._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 597, 6)
    __Sello._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 597, 6)
    ...
    __FormaPago._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 607, 6)
    __FormaPago._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 607, 6)
    ...
    __NoCertificado = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'NoCertificado'), 'NoCertificado', '__httpwww_sat_gob_mxcfd3_CTD_ANON_9_NoCertificado', _module_typeBindings.STD_ANON_20, required=True)
    __NoCertificado._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 612, 6)
    __NoCertificado._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 612, 6)
    ...
    __Certificado = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'Certificado'), 'Certificado', '__httpwww_sat_gob_mxcfd3_CTD_ANON_9_Certificado', _module_typeBindings.STD_ANON_21, required=True)
    __Certificado._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 624, 6)
    __Certificado._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 624, 6)
    ...
    __CondicionesDePago = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'CondicionesDePago'), 'CondicionesDePago', '__httpwww_sat_gob_mxcfd3_CTD_ANON_9_CondicionesDePago', _module_typeBindings.STD_ANON_22)
    __CondicionesDePago._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 634, 6)
    __CondicionesDePago._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 634, 6)
    ...
    __SubTotal._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 647, 6)
    __SubTotal._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 647, 6)
    ...
    __Descuento._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 652, 6)
    __Descuento._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 652, 6)
    ...
    __Moneda._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 657, 6)
    __Moneda._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 657, 6)
    ...
    __TipoCambio = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'TipoCambio'), 'TipoCambio', '__httpwww_sat_gob_mxcfd3_CTD_ANON_9_TipoCambio', _module_typeBindings.STD_ANON_23)
    __TipoCambio._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 662, 6)
    __TipoCambio._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 662, 6)
    ...
    __Total._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 674, 6)
    __Total._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 674, 6)
    ...
    __TipoDeComprobante._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 679, 6)
    __TipoDeComprobante._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 679, 6)
    ...
    __MetodoPago._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 684, 6)
    __MetodoPago._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 684, 6)
    ...
    __LugarExpedicion._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 689, 6)
    __LugarExpedicion._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 689, 6)
    ...
    __Confirmacion = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'Confirmacion'), 'Confirmacion', '__httpwww_sat_gob_mxcfd3_CTD_ANON_9_Confirmacion', _module_typeBindings.STD_ANON_24)
    __Confirmacion._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 694, 6)
    __Confirmacion._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 694, 6)
...
class CTD_ANON_10 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 15, 10)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.sat.gob.mx/cfd/3}CfdiRelacionado uses Python identifier CfdiRelacionado
    __CfdiRelacionado = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'CfdiRelacionado'), 'CfdiRelacionado', '__httpwww_sat_gob_mxcfd3_CTD_ANON_10_httpwww_sat_gob_mxcfd3CfdiRelacionado', True, pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 17, 14), )
    ...
    __TipoRelacion._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 37, 12)
    __TipoRelacion._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 37, 12)
...
class CTD_ANON_11 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 21, 16)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Attribute UUID uses Python identifier UUID
    __UUID = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'UUID'), 'UUID', '__httpwww_sat_gob_mxcfd3_CTD_ANON_11_UUID', _module_typeBindings.STD_ANON)
    __UUID._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 22, 18)
    __UUID._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 22, 18)
    
    UUID = property(__UUID.value, __UUID.set, None, 'Atributo opcional para registrar el folio fiscal (UUID) de un CFDI relacionado con el presente comprobante, por ejemplo: Si el CFDI relacionado es un comprobante de traslado que sirve para registrar el movimiento de la mercancía. Si este comprobante se usa como nota de crédito o nota de débito del comprobante relacionado. Si este comprobante es una devolución sobre el comprobante relacionado. Si éste sustituye a una factura cancelada.')
...
class CTD_ANON_12 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 48, 10)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __Rfc._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 49, 12)
    __Rfc._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 49, 12)
    ...
    __Nombre._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 54, 12)
    __Nombre._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 54, 12)
    ...
    __RegimenFiscal._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 67, 12)
    __RegimenFiscal._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 67, 12)
...
class CTD_ANON_13 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 78, 10)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __Rfc._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 79, 12)
    __Rfc._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 79, 12)
    ...
    __Nombre._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 84, 12)
    __Nombre._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 84, 12)
    ...
    __ResidenciaFiscal._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 97, 12)
    __ResidenciaFiscal._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 97, 12)
    ...
    __NumRegIdTrib._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 102, 12)
    __NumRegIdTrib._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 102, 12)
    ...
    __UsoCFDI._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 114, 12)
    __UsoCFDI._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 114, 12)
...
class CTD_ANON_14 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 131, 16)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.sat.gob.mx/cfd/3}Impuestos uses Python identifier Impuestos
    __Impuestos = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Impuestos'), 'Impuestos', '__httpwww_sat_gob_mxcfd3_CTD_ANON_14_httpwww_sat_gob_mxcfd3Impuestos', False, pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 133, 20), )
    ...
    __InformacionAduanera = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'InformacionAduanera'), 'InformacionAduanera', '__httpwww_sat_gob_mxcfd3_CTD_ANON_14_httpwww_sat_gob_mxcfd3InformacionAduanera', True, pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 231, 20), )
    ...
    __CuentaPredial = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'CuentaPredial'), 'CuentaPredial', '__httpwww_sat_gob_mxcfd3_CTD_ANON_14_httpwww_sat_gob_mxcfd3CuentaPredial', False, pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 249, 20), )
    ...
    __ComplementoConcepto = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'ComplementoConcepto'), 'ComplementoConcepto', '__httpwww_sat_gob_mxcfd3_CTD_ANON_14_httpwww_sat_gob_mxcfd3ComplementoConcepto', False, pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 269, 20), )
    ...
    __Parte = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Parte'), 'Parte', '__httpwww_sat_gob_mxcfd3_CTD_ANON_14_httpwww_sat_gob_mxcfd3Parte', True, pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 279, 20), )
    ...
    __ClaveProdServ._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 373, 18)
    __ClaveProdServ._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 373, 18)
    ...
    __NoIdentificacion = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'NoIdentificacion'), 'NoIdentificacion', '__httpwww_sat_gob_mxcfd3_CTD_ANON_14_NoIdentificacion', _module_typeBindings.STD_ANON_12)
    __NoIdentificacion._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 378, 18)
    __NoIdentificacion._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 378, 18)
    ...
    __Cantidad = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'Cantidad'), 'Cantidad', '__httpwww_sat_gob_mxcfd3_CTD_ANON_14_Cantidad', _module_typeBindings.STD_ANON_13, required=True)
    __Cantidad._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 391, 18)
    __Cantidad._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 391, 18)
    ...
    __ClaveUnidad._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 403, 18)
    __ClaveUnidad._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 403, 18)
    ...
    __Unidad = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'Unidad'), 'Unidad', '__httpwww_sat_gob_mxcfd3_CTD_ANON_14_Unidad', _module_typeBindings.STD_ANON_14)
    __Unidad._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 408, 18)
    __Unidad._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 408, 18)
    ...
    __Descripcion = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'Descripcion'), 'Descripcion', '__httpwww_sat_gob_mxcfd3_CTD_ANON_14_Descripcion', _module_typeBindings.STD_ANON_15, required=True)
    __Descripcion._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 421, 18)
    __Descripcion._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 421, 18)
    ...
    __ValorUnitario._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 434, 18)
    __ValorUnitario._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 434, 18)
    ...
    __Importe._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 439, 18)
    __Importe._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 439, 18)
    ...
    __Descuento._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 444, 18)
    __Descuento._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 444, 18)
...
class CTD_ANON_15 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 149, 34)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Attribute Base uses Python identifier Base
    __Base = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'Base'), 'Base', '__httpwww_sat_gob_mxcfd3_CTD_ANON_15_Base', _ImportedBinding__tdCFDI.t_Importe, required=True)
    __Base._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 150, 36)
    __Base._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 150, 36)
    ...
    __Impuesto._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 155, 36)
    __Impuesto._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 155, 36)
    ...
    __TipoFactor._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 160, 36)
    __TipoFactor._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 160, 36)
    ...
    __TasaOCuota = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'TasaOCuota'), 'TasaOCuota', '__httpwww_sat_gob_mxcfd3_CTD_ANON_15_TasaOCuota', _ImportedBinding__catCFDI.c_TasaOCuota)
    __TasaOCuota._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 165, 36)
    __TasaOCuota._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 165, 36)
    
    TasaOCuota = property(__TasaOCuota.value, __TasaOCuota.set, None, 'Atributo condicional para señalar el valor de la tasa o cuota del impuesto que se traslada para el presente concepto. Es requerido cuando el atributo TipoFactor tenga un valor que corresponda a Tasa o Cuota.')
    ...
    __Importe._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 170, 36)
    __Importe._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 170, 36)
...
class CTD_ANON_16 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 190, 34)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Attribute Base uses Python identifier Base
    __Base = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'Base'), 'Base', '__httpwww_sat_gob_mxcfd3_CTD_ANON_16_Base', _ImportedBinding__tdCFDI.t_Importe, required=True)
    __Base._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 191, 36)
    __Base._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 191, 36)
    ...
    __Impuesto._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 196, 36)
    __Impuesto._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 196, 36)
    ...
    __TipoFactor._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 201, 36)
    __TipoFactor._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 201, 36)
    
    TipoFactor = property(__TipoFactor.value, __TipoFactor.set, None, 'Atributo requerido para señalar la clave del tipo de factor que se aplica a la base del impuesto.')

    
    # Attribute TasaOCuota uses Python identifier TasaOCuota
    __TasaOCuota = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'TasaOCuota'), 'TasaOCuota', '__httpwww_sat_gob_mxcfd3_CTD_ANON_16_TasaOCuota', _module_typeBindings.STD_ANON_4, required=True)
    __TasaOCuota._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 206, 36)
    __TasaOCuota._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 206, 36)
    ...
    __Importe._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 218, 36)
    __Importe._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 218, 36)
...
class CTD_ANON_17 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 235, 22)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Attribute NumeroPedimento uses Python identifier NumeroPedimento
    __NumeroPedimento = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'NumeroPedimento'), 'NumeroPedimento', '__httpwww_sat_gob_mxcfd3_CTD_ANON_17_NumeroPedimento', _module_typeBindings.STD_ANON_5, required=True)
    __NumeroPedimento._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 236, 24)
    __NumeroPedimento._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 236, 24)
...
class CTD_ANON_18 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 253, 22)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Attribute Numero uses Python identifier Numero
    __Numero = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'Numero'), 'Numero', '__httpwww_sat_gob_mxcfd3_CTD_ANON_18_Numero', _module_typeBindings.STD_ANON_6, required=True)
    __Numero._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 254, 24)
    __Numero._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 254, 24)
...
class CTD_ANON_19 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 283, 22)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.sat.gob.mx/cfd/3}InformacionAduanera uses Python identifier InformacionAduanera
    __InformacionAduanera = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'InformacionAduanera'), 'InformacionAduanera', '__httpwww_sat_gob_mxcfd3_CTD_ANON_19_httpwww_sat_gob_mxcfd3InformacionAduanera', True, pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 285, 26), )
    ...
    __ClaveProdServ._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 304, 24)
    __ClaveProdServ._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 304, 24)
    ...
    # Attribute NoIdentificacion uses Python identifier NoIdentificacion
    __NoIdentificacion = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'NoIdentificacion'), 'NoIdentificacion', '__httpwww_sat_gob_mxcfd3_CTD_ANON_19_NoIdentificacion', _module_typeBindings.STD_ANON_8)
    __NoIdentificacion._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 309, 24)
    __NoIdentificacion._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 309, 24)
    ...
    # Attribute Cantidad uses Python identifier Cantidad
    __Cantidad = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'Cantidad'), 'Cantidad', '__httpwww_sat_gob_mxcfd3_CTD_ANON_19_Cantidad', _module_typeBindings.STD_ANON_9, required=True)
    __Cantidad._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 322, 24)
    __Cantidad._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 322, 24)
    ...
    # Attribute Unidad uses Python identifier Unidad
    __Unidad = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'Unidad'), 'Unidad', '__httpwww_sat_gob_mxcfd3_CTD_ANON_19_Unidad', _module_typeBindings.STD_ANON_10)
    __Unidad._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 334, 24)
    __Unidad._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 334, 24)
    ...
    # Attribute Descripcion uses Python identifier Descripcion
    __Descripcion = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'Descripcion'), 'Descripcion', '__httpwww_sat_gob_mxcfd3_CTD_ANON_19_Descripcion', _module_typeBindings.STD_ANON_11, required=True)
    __Descripcion._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 347, 24)
    __Descripcion._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 347, 24)
    ...
    __ValorUnitario._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 360, 24)
    __ValorUnitario._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 360, 24)
    ...
    __Importe._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 365, 24)
    __Importe._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 365, 24)
...
class CTD_ANON_20 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 289, 28)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Attribute NumeroPedimento uses Python identifier NumeroPedimento
    __NumeroPedimento = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'NumeroPedimento'), 'NumeroPedimento', '__httpwww_sat_gob_mxcfd3_CTD_ANON_20_NumeroPedimento', _module_typeBindings.STD_ANON_7, required=True)
    __NumeroPedimento._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 290, 30)
    __NumeroPedimento._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 290, 30)
...
class CTD_ANON_21 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 458, 10)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.sat.gob.mx/cfd/3}Retenciones uses Python identifier Retenciones
    __Retenciones = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Retenciones'), 'Retenciones', '__httpwww_sat_gob_mxcfd3_CTD_ANON_21_httpwww_sat_gob_mxcfd3Retenciones', False, pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 460, 14), )
    ...
    # Element {http://www.sat.gob.mx/cfd/3}Traslados uses Python identifier Traslados
    __Traslados = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Traslados'), 'Traslados', '__httpwww_sat_gob_mxcfd3_CTD_ANON_21_httpwww_sat_gob_mxcfd3Traslados', False, pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 486, 14), )
    ...
    __TotalImpuestosRetenidos._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 523, 12)
    __TotalImpuestosRetenidos._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 523, 12)
    ...
    __TotalImpuestosTrasladados._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 528, 12)
    __TotalImpuestosTrasladados._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 528, 12)
...
class CTD_ANON_22 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 470, 22)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __Impuesto._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 471, 24)
    __Impuesto._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 471, 24)
    ...
    __Importe._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 476, 24)
    __Importe._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 476, 24)
...
class CTD_ANON_23 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 496, 22)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __Impuesto._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 497, 24)
    __Impuesto._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 497, 24)
    ...
    __TipoFactor._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 502, 24)
    __TipoFactor._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 502, 24)
    
    TipoFactor = property(__TipoFactor.value, __TipoFactor.set, None, 'Atributo requerido para señalar la clave del tipo de factor que se aplica a la base del impuesto.')

    
    # Attribute TasaOCuota uses Python identifier TasaOCuota
    __TasaOCuota = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'TasaOCuota'), 'TasaOCuota', '__httpwww_sat_gob_mxcfd3_CTD_ANON_23_TasaOCuota', _ImportedBinding__catCFDI.c_TasaOCuota, required=True)
    __TasaOCuota._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 507, 24)
    __TasaOCuota._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 507, 24)
    ...
    __Importe._DeclarationLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 512, 24)
    __Importe._UseLocation = pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 512, 24)
...
Comprobante = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Comprobante'), CTD_ANON_9, documentation='Estándar de Comprobante Fiscal Digital por Internet.', location=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 5, 2))
Namespace.addCategoryObject('elementBinding', Comprobante.name().localName(), Comprobante)



CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Concepto'), CTD_ANON_14, scope=CTD_ANON, documentation='Nodo requerido para registrar la información detallada de un bien o servicio amparado en el comprobante.', location=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 127, 14)))
...
def _BuildAutomaton ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Concepto')), pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 127, 14))
...
CTD_ANON_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Traslados'), CTD_ANON_2, scope=CTD_ANON_, documentation='Nodo opcional para asentar los impuestos trasladados aplicables al presente concepto.', location=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 139, 26)))

CTD_ANON_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Retenciones'), CTD_ANON_3, scope=CTD_ANON_, documentation='Nodo opcional para asentar los impuestos retenidos aplicables al presente concepto.', location=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 180, 26)))
...
def _BuildAutomaton_ ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 139, 26))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 180, 26))
    counters.add(cc_1)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Traslados')), pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 139, 26))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Retenciones')), pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 180, 26))
...
def _BuildAutomaton_2 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Traslado')), pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 145, 32))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_3 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Retencion')), pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 186, 32))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_4 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 275, 26))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.WildcardUse(pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_strict, namespace_constraint=pyxb.binding.content.Wildcard.NC_any), pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 275, 26))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_5 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Retencion')), pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 466, 20))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_6 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Traslado')), pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 492, 20))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_7 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 541, 14))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.WildcardUse(pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_strict, namespace_constraint=pyxb.binding.content.Wildcard.NC_any), pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 541, 14))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_8 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.WildcardUse(pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_strict, namespace_constraint=pyxb.binding.content.Wildcard.NC_any), pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 551, 14))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CfdiRelacionados'), CTD_ANON_10, scope=CTD_ANON_9, documentation='Nodo opcional para precisar la información de los comprobantes relacionados.', location=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 11, 8)))

CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Emisor'), CTD_ANON_12, scope=CTD_ANON_9, documentation='Nodo requerido para expresar la información del contribuyente emisor del comprobante.', location=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 44, 8)))

CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Receptor'), CTD_ANON_13, scope=CTD_ANON_9, documentation='Nodo requerido para precisar la información del contribuyente receptor del comprobante.', location=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 74, 8)))

CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Conceptos'), CTD_ANON, scope=CTD_ANON_9, documentation='Nodo requerido para listar los conceptos cubiertos por el comprobante.', location=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 121, 8)))

CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Impuestos'), CTD_ANON_21, scope=CTD_ANON_9, documentation='Nodo condicional para expresar el resumen de los impuestos aplicables.', location=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 454, 8)))

CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Complemento'), CTD_ANON_7, scope=CTD_ANON_9, documentation='Nodo opcional donde se incluye el complemento Timbre Fiscal Digital de manera obligatoria y los nodos complementarios determinados por el SAT, de acuerdo con las disposiciones particulares para un sector o actividad específica.', location=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 535, 8)))

CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Addenda'), CTD_ANON_8, scope=CTD_ANON_9, documentation='Nodo opcional para recibir las extensiones al presente formato que sean de utilidad al contribuyente. Para las reglas de uso del mismo, referirse al formato origen.', location=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 545, 8)))
...
def _BuildAutomaton_9 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 11, 8))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 454, 8))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 535, 8))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 545, 8))
    counters.add(cc_3)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CfdiRelacionados')), pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 11, 8))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Emisor')), pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 44, 8))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Receptor')), pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 74, 8))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Conceptos')), pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 121, 8))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Impuestos')), pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 454, 8))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Complemento')), pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 535, 8))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Addenda')), pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 545, 8))
...
CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CfdiRelacionado'), CTD_ANON_11, scope=CTD_ANON_10, documentation='Nodo requerido para precisar la información de los comprobantes relacionados.', location=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 17, 14)))
...
def _BuildAutomaton_10 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CfdiRelacionado')), pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 17, 14))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Impuestos'), CTD_ANON_, scope=CTD_ANON_14, documentation='Nodo opcional para capturar los impuestos aplicables al presente concepto. Cuando un concepto no registra un impuesto, implica que no es objeto del mismo.', location=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 133, 20)))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'InformacionAduanera'), CTD_ANON_17, scope=CTD_ANON_14, documentation='Nodo opcional para introducir la información aduanera aplicable cuando se trate de ventas de primera mano de mercancías importadas o se trate de operaciones de comercio exterior con bienes o servicios.', location=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 231, 20)))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CuentaPredial'), CTD_ANON_18, scope=CTD_ANON_14, documentation='Nodo opcional para asentar el número de cuenta predial con el que fue registrado el inmueble, en el sistema catastral de la entidad federativa de que trate, o bien para incorporar los datos de identificación del certificado de participación inmobiliaria no amortizable.', location=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 249, 20)))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ComplementoConcepto'), CTD_ANON_4, scope=CTD_ANON_14, documentation='Nodo opcional donde se incluyen los nodos complementarios de extensión al concepto definidos por el SAT, de acuerdo con las disposiciones particulares para un sector o actividad específica.', location=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 269, 20)))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Parte'), CTD_ANON_19, scope=CTD_ANON_14, documentation='Nodo opcional para expresar las partes o componentes que integran la totalidad del concepto expresado en el comprobante fiscal digital por Internet.', location=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 279, 20)))
...
def _BuildAutomaton_11 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 133, 20))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 231, 20))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 249, 20))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 269, 20))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 279, 20))
    counters.add(cc_4)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Impuestos')), pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 133, 20))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'InformacionAduanera')), pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 231, 20))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CuentaPredial')), pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 249, 20))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ComplementoConcepto')), pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 269, 20))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Parte')), pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 279, 20))
...
CTD_ANON_19._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'InformacionAduanera'), CTD_ANON_20, scope=CTD_ANON_19, documentation='Nodo opcional para introducir la información aduanera aplicable cuando se trate de ventas de primera mano de mercancías importadas o se trate de operaciones de comercio exterior con bienes o servicios.', location=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 285, 26)))
...
def _BuildAutomaton_12 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 285, 26))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_19._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'InformacionAduanera')), pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 285, 26))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_21._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Retenciones'), CTD_ANON_5, scope=CTD_ANON_21, documentation='Nodo condicional para capturar los impuestos retenidos aplicables. Es requerido cuando en los conceptos se registre algún impuesto retenido.', location=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 460, 14)))

CTD_ANON_21._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Traslados'), CTD_ANON_6, scope=CTD_ANON_21, documentation='Nodo condicional para capturar los impuestos trasladados aplicables. Es requerido cuando en los conceptos se registre un impuesto trasladado.', location=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 486, 14)))
...
def _BuildAutomaton_13 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 460, 14))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 486, 14))
    counters.add(cc_1)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_21._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Retenciones')), pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 460, 14))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_21._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Traslados')), pyxb.utils.utility.Location('/home/j2eeserver/borrame/cfdv33.xsd', 486, 14))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
